                      ...
                      <div class="ps-3">
                        <form class="card-body">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <select id="inputLog" class="form-control" name="log" required><br>
                            ...
                            <div class="col">
                              ...
                              <input type="time" size="10" name="time" required>
                              <input type="submit" class="btn btn-primary" name="time_check" value="SUBMIT">
                            </div>
                          </div>
                          </div>
                                    ...
                                    <table id="myTable" class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $gettask= mysqli_query($conn, "SELECT * FROM tasks WHERE school_id='$id'");
                                    ...
                                    <table id="myTable" class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $gettime= mysqli_query($conn, "SELECT * FROM time_checked WHERE school_id='$id'");
